...
public class RingOfSaturationItem extends Item{
    public RingOfSaturationItem() {
    ...
    public void appendHoverText(ItemStack pStack, TooltipContext pContext, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag) {
        ...
        pTooltipComponents.add(ComponentUtil.translateItem("ring_of_saturation.description").withStyle(ChatFormatting.GRAY));
