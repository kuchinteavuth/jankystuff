...
public class MetalCrateScreen extends AbstractContainerScreen<MetalCrateMenu> implements MenuAccess<MetalCrateMenu> {

    private final Texture texture;

    public MetalCrateScreen(MetalCrateMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle);
        this.texture = ContainerType.METAL.getGui().getTexture();
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        pGuiGraphics.drawString(this.font, this.title, 0, -10, ChatFormatting.WHITE.getColor(), false);
